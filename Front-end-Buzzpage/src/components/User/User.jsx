    ...
    return (
        <div className={`${styles.container}`}>
            <div className="row">
                ...
                <div className="col-9">
                    <div className="row w-100 mt-3 p-3 d-flex justify-content-around">
                        <div className={`card bg-dark d-flex justify-content-center align-items-center`} style={{ width: "45%" }}>
                        ...
                        <div className={`card d-flex bg-dark p-3`} style={{ color: "#F4BE1E", width: "45%" }}>
                    ...
                    <div className="row">
                        <h1 className={"m-auto mt-3 text-center text-light"}>All Posts</h1>
                    </div>
                </div>
            </div>
        </div>
